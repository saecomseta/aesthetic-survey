    ...
    <AdminGuard requireSuperAdmin={true}>
      <div className="max-w-3xl mx-auto p-4 lg:p-10 pb-20">
        ...
        <div className="max-w-lg mx-auto bg-white rounded-3xl p-8 md:p-12 border border-beige-200 shadow-sm flex flex-col items-center text-center mt-12">
          ...
          <div className="bg-primary-50 p-8 rounded-full border border-primary-100 shadow-inner mb-6 animate-in zoom-in duration-500">
          ...
          <div className="flex flex-col gap-3 w-full">
            <a 
              ...
              className="w-full flex items-center justify-center gap-2 py-4 bg-primary-900 text-white rounded-2xl hover:bg-black transition font-bold shadow-lg hover:scale-[1.01]"
            >
